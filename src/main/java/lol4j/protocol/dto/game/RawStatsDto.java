...
public class RawStatsDto {
    ...
    private int neutralMonstersKilled;
    private int neutralMonstersKilledEnemyJungle;
    private int neutralMonstersKilledYourJungle;
    ...
    public int getNeutralMonstersKilledEnemyJungle() {
        return neutralMonstersKilledEnemyJungle;
    }

    public void setNeutralMonstersKilledEnemyJungle(int neutralMonstersKilledEnemyJungle) {
        this.neutralMonstersKilledEnemyJungle = neutralMonstersKilledEnemyJungle;
    }

    public int getNeutralMonstersKilledYourJungle() {
        return neutralMonstersKilledYourJungle;
    }

    public void setNeutralMonstersKilledYourJungle(int neutralMonstersKilledYourJungle) {
        this.neutralMonstersKilledYourJungle = neutralMonstersKilledYourJungle;
    }
